...
public final class MathFunctionParser {
    ...
    public static final class Implicit {
        ...
        public static String replaceX(final String function,
            ...
            return changed.replace(FIRST + FS, Precision.format(x));
        }
        ...
        public static String replaceY(final String function,
            ...
            return changed.replace(SECOND + SS, Precision.format(y));
        }
    ...
    public static final class Explicit {
        ...
        public static String replaceVariable(final String function, final double value) {
            ...
            return changed.replace(VARIABLE_SPLITTER + variable, Precision.format(value));
        }

        public static List<String> getCoefficients(final String function) {
        ...
        public static String replaceCoefficient(final String function,
            ...
            return changed.toString().replace(COEFFICIENT_SPLITTER + coefficient, Precision.format(value));
        }
    }
}
