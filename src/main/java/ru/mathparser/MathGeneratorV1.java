...
public class MathGeneratorV1 extends AbstractMathGenerator implements MathConstants {
    ...
    private static final List<String> MATH_CONSTANTS_LIST =
    ...
    private int getArgsSize(String mathFunction) {
        ...
        if (required.charAt(0) == '+') {
            args = randomInRange(Integer.parseInt(String.valueOf(required.charAt(1))), this.maxArgs);
        } else {
            args = Integer.parseInt(String.valueOf(required.charAt(0)));
        }
    ...
    private String generateSimpleVariableExpression(final Character variable,
        ...
        result.append(")".repeat(Math.max(0, leftCount)));
