...
public class Plant0 implements InterfacePlantClass.Settable,
    ...
    public Plant0(String _pdate) {
        this.date = _pdate;
    }

    public Plant0(String _pdate, String _FORMAT) {
        this.setFormat(_FORMAT);
        this.date = _pdate;
    }

    public Plant0(int _pyear) {
...
class Tree0 extends Plant0 implements InterfacePlantClass.Action,
    ...
    public Tree0(String _pdate) {
        super(_pdate);
        this._init_tree();
    }

    public Tree0(String _pdate, String _distribution, String _base_color) {
        super(_pdate);
    ...
    public boolean equals(Tree0 other) {
...
class Flower0 extends Plant0 implements InterfacePlantClass.Action,
        InterfacePlantClass.Redefinable, InterfacePlantClass.Subclass {
    ...
    public Flower0(String _pdate) {
        super(_pdate);
        this._init_flower();
    }

    public Flower0(String _pdate, String _fclass, String _distribution, String _color) {
        super(_pdate);
        this.fclass = _fclass;
        this.distribution = _distribution;
        this.color = _color;
    ...
    public boolean equals(Flower0 other) {
        return ((this.date.equals(other.date))
