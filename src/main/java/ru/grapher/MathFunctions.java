...
public final class MathFunctions {
    ...
    public static final HashMap<String, String>        REQUIRED_ARGS = new HashMap<>();
    public static final HashMap<String, MathFunction>  FUNCTION_MAP  = new HashMap<>();
    public static final ArrayList<String>              SORTED_NAMES  = new ArrayList<>();
    ...
    static {
        ...
        FUNCTION_MAP.put("pow", args -> {
            if (args.size() != 2)
                ...
                return bounded(Math.pow(args.get(0), args.get(1)));
            }
        });
        ...
        FUNCTION_MAP.put("arcsin", args -> {
            ...
            return bounded(Math.asin(args.getFirst()));
        });
    ...
    private static double normal(final double x,
        ...
        final double exp1 = Math.pow(exp0, 2.0) * (-1.0 / 2.0);
