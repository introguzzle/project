...
public class HelpFrame extends InformationFrame {
    ...
    public HelpFrame(JFrame owner) {
        super(owner, "Help", TEXT, FONT);

        showButton.addActionListener(e -> new MathFunctionsDescriptionsFrame(owner).setVisible(true));
        exitButton.addActionListener(e -> this.dispose());

        this.setIconImage(owner != null ? owner.getIconImage() : null);
        this.setTitle("Help");
    }
